            ...
            <>
                    ...
                    <li key={r.id}>
                      <button
                        ...
                        style={{
                          background: "#FFFDF9",
                          borderRadius: 12,
                          border: isSel ? "2px solid #2D6A4F" : "0.5px solid rgba(26,17,8,0.12)",
              ...
              <div className="mt-8 flex justify-center">
                <button
                  ...
                  style={{
                    background: selected.length === 2 ? "#2D6A4F" : "#D1CFC8",
                    color: "#FFFDF9",
                    fontSize: 13,
                    fontWeight: 500,
                    borderRadius: 100,
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-8 sm:px-6 sm:py-12">
        <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
          ...
          <button
            ...
            style={{
              background: emailSent ? "#5F8A6A" : "#2D6A4F",
              color: "#FFFDF9",
              fontSize: 13,
              fontWeight: 500,
              borderRadius: 100,
    ...
    <ul style={{ margin: 0, padding: 0, listStyle: "none" }}>
      {flags.map((f, i) => (
        <li key={i} style={{ fontSize: 13, color: "#1A1108", lineHeight: 1.5, marginBottom: 6 }}>
          <span style={{ color: "#2D6A4F", fontWeight: 700 }}>•</span> {f.title}
        </li>
      ))}
    </ul>
  );
