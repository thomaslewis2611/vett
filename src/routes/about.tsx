...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About vett — Honest AI property analysis for UK home buyers" },
      {
        name: "description",
        content:
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#F1EFE8" }}>
      ...
      <main className="mx-auto w-full max-w-3xl px-6 sm:px-8 py-20 sm:py-28 flex-1">
        ...
        >
          Why we built <em style={{ fontStyle: "italic", color: "#2D6A4F" }}>vett</em>
        </h1>
        <p
        ...
        <Section heading="What vett is">
          vett is an AI property analysis tool for UK home buyers. It reads listing descriptions, extracts key data, and surfaces everything an experienced buyer would notice — written in plain English, not agent jargon.
        </Section>

        <Section heading="What vett is not">
          vett is not a solicitor, surveyor, or financial advisor. Every report is AI-generated and advisory only. Always verify important information independently and seek professional advice before making any offer.
        </Section>

        <Section heading="Get in touch">
          Questions, feedback, or press enquiries — email us at{" "}
          <a href="mailto:support@vetthome.com" style={{ color: "#2D6A4F", fontWeight: 400 }} className="hover:underline">
            support@vetthome.com
          </a>
        </Section>
      </main>
      <SiteFooter />
