...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Paste any Rightmove or Zoopla listing and get an instant AI analysis. Red flags, true costs, value score and negotiation strategy in seconds." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@roovr" },
      { name: "twitter:title", content: "Roovr — AI property analysis for smarter buyers" },
      { name: "twitter:description", content: "Paste any Rightmove or Zoopla listing and get an instant AI analysis. Red flags, true costs, value score and negotiation strategy in seconds." },
