    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#FFFDF9" }}>
      ...
      <main className="mx-auto w-full max-w-3xl px-8 py-20 flex-1">
        ...
        <Section n={2} title="AI-generated content disclaimer">
          All report content generated by Roovr is AI-powered and advisory only. It does not constitute professional property, legal, financial, or surveying advice. Always seek independent professional advice before making any property purchase decision.
        </Section>
        <Section n={3} title="Acceptable use">
          Roovr is intended for individual home buyers researching properties for personal use. Commercial use of report data for investment analysis, resale, or bulk property research requires prior written consent from Roovr.
        </Section>
        ...
        <Section n={7} title="Limitation of liability">
          Roovr is not liable for any decisions made based on report content. Reports are provided as informational tools only. Our maximum liability in any circumstance is limited to the amount paid for the report in question.
        </Section>
