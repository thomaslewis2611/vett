        ...
        const itemRows = items
          .map(
            ...
            <tr><td style="padding:8px 0;border-bottom:1px solid rgba(26,17,8,0.06);">
              <div style="font-size:13px;color:#1A1108;line-height:1.5;"><span style="color:#2D6A4F;font-weight:700;">→</span> ${escapeHtml(it.item)}</div>
  ...
  <div class="content" style="max-width:600px;margin:0 auto;padding:0;">
    ...
    <div class="px" style="background:#FFFDF9;padding:32px 24px;">
      ...
      <div style="margin:36px 0 8px;text-align:center;">
        <a href="${escapeHtml(resultsUrl)}" class="cta-btn" style="background:#2D6A4F;color:#FFFDF9;font-size:15px;font-weight:600;border-radius:8px;padding:14px 24px;text-decoration:none;display:inline-block;min-height:44px;line-height:1.2;">View full report online →</a>
      </div>
