    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Click the button below to access your vett report. This link is unique to you and expires in 24 hours.
          </Text>
          ...
          <Text style={smallMuted}>If you didn't request this link, you can safely ignore this email.</Text>
        </Section>
